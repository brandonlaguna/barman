...
import { SILPOS_LOCAL, SILPOS_WEB, server } from "config/contants";
import PropTypes from "prop-types";
import { cardImageStyle } from "./style";
import "./styles.css";

export default function ItemsCard({ data, onclickItem, categoryImg }) {
  ...
  if (url_foto !== null) {
    ...
    background = `${server === "online" ? SILPOS_WEB : SILPOS_LOCAL}/img/categorias/${categoryImg}`;
  }
